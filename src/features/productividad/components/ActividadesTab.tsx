...
import type { TipoActividad, EstadoActividad } from '../types/productividad.types';
import { format } from 'date-fns';
import { es } from 'date-fns/locale';

export const ActividadesTab = ({
  contactoId,
  contactoNombre,
}: {
  contactoId: string;
  ...
  const { data, isLoading, isSubmitting, addActividad, updateEstado } = useActividades(contactoId);
