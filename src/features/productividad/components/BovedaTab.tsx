...
import { useBoveda } from '../hooks/use-boveda';
import { FileText, Trash2, UploadCloud, File } from 'lucide-react';
import { format } from 'date-fns';

export const BovedaTab = ({ contactoId }: { contactoId: string }) => {
  const { data, isLoading, isUploading, uploadFile, deleteFile } = useBoveda(contactoId);
